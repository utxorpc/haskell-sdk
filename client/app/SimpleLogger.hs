...
simpleRequestL :: RequestLogger IO
simpleRequestL rpcPath client uuid req = do
...
simpleReplyL :: ReplyLogger IO
simpleReplyL rpcPath client uuid reply = do
...
simpleServerChunkL :: ServerStreamDataLogger IO
simpleServerChunkL rpcPath client (uuid, index) o = do
  footer <- printPreamble "STREAM DATA" rpcPath client uuid
  putStrLn $ "Message (#" ++ show index ++ "):"
  putStrLn $ indent 1 (show o)
  putStrLn footer

simpleServerStreamEndL :: ServerStreamEndLogger IO
